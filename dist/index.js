...
(() => {
  ...
  var toArray = function toArray2(value, scope, leaveStrings) {
    return _context2 && !scope && _context2.selector ? _context2.selector(value) : _isString(value) && !leaveStrings && (_coreInitted2 || !_wake()) ? _slice.call((scope || _doc).querySelectorAll(value), 0) : _isArray(value) ? _flatten(value, leaveStrings) : _isArrayLike(value) ? _slice.call(value, 0) : value ? [value] : [];
  };
  ...
  var _callback = function _callback2(animation, type, executeLazyFirst) {
    var v = animation.vars, callback = v[type], prevContext = _context2, context3 = animation._ctx, params, scope, result;
    if (!callback) {
      return;
    }
  ...
  var _ticker = function() {
    ...
    _self = {
      ...
      deltaRatio: function deltaRatio(fps2) {
        return _delta / (1e3 / (fps2 || 60));
      },
      wake: function wake() {
        if (_coreReady) {
          if (!_coreInitted2 && _windowExists()) {
            _win = _coreInitted2 = window;
            _doc = _win.document || {};
            _globals.gsap = gsap2;
  ...
  var _dispatch = function _dispatch2(type) {
    return (_listeners[type] || _emptyArray2).map(function(f) {
      return f();
    });
  };
  ...
  var MatchMedia = /* @__PURE__ */ function() {
    ...
    _proto6.add = function add(conditions, func, scope) {
      ...
      _context2 && !context3.selector && (context3.selector = _context2.selector);
    ...
    quickSetter: function quickSetter(target, property, unit) {
      ...
      if (target.length > 1) {
        var setters = target.map(function(t2) {
          return gsap2.quickSetter(t2, property, unit);
        }), l = setters.length;
        return function(value) {
          var i = l;
          while (i--) {
  ...
  var assert = (value, message, condition) => {
  ...
  var charRevealElements = document.querySelectorAll(selectors.revealType);
  var loaderDuration = Number.parseInt(document.body.dataset.loaderDuration ?? "");
  var doesLoaderExist = !Number.isNaN(loaderDuration);
  var init5 = () => {
    for (let i = 0; i < charRevealElements.length; i++) {
      const charRevealEl = charRevealElements[i];
      const charRevealParentEl = charRevealEl.closest(selectors.revealParent) || charRevealEl;
      const resetAnimationParent = charRevealEl.closest(selectors.resetAnimation);
      ...
      const getKeepSplit = () => {
        ...
        if (keepSplitValue === "true")
          return true;
        if (keepSplitValue === "false")
          return false;
        return false;
      };
      let keepSplit = getKeepSplit();
      let initialAnimationProps = {};
      let finalAnimationProps = {};
      ...
      const initTimeline = () => {
        ctx = gsapWithCSS.context(() => {
          tl = gsapWithCSS.timeline({ paused: true });
